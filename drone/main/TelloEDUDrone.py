...
class TelloDrone:
    """Wrapper class to simplify Tello EDU Drone interaction"""
    
    def __init__(self, local_ip, local_port, imperial=False, command_timeout=0.3,
                 tello='192.168.10.1', tello_port=8889):
        """
    ...
    def takeoff(self):
        ...
        Initiates take-off.
        Returns:
            str: Response from Tello, 'Ok' or 'Error'.
        """
    ...
    def set_speed(self, speed):
        """
        Sets speed.
        This method expects inches/second or centimeters/second. The Tello API expects speeds from
        1 to 100 centimeters/second.

        Metric: 1 to 100 cm/s
        Imperial: 0.4 to 39 in/s
    ...
    def move(self, direction, distance):
        ...
        This method expects inches or centimeters. The Tello API expects distances
        from 20 to 500 centimeters.

        Metric: 20 to 500 centimeters
        Imperial: 7.9 to 196 inches
        ...
        if self.imperial is True:
            distance = int(round(distance * 2.54))
